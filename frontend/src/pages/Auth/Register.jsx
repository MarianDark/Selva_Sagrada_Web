    ...
    >
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-3 inline-flex h-9 w-9 items-center justify-center rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500"
        >
          <img
