...
function EyeButton({ pressed, onToggle, labelShow, labelHide }) {
  return (
    <button
      ...
      className="absolute right-2 top-2/3 -translate-y-1/2 inline-flex h-9 w-9 items-center justify-center rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500"
    >
